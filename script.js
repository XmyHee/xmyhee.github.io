try {
    ...
    // 节点数据
    const nodeData = [
        { name: "AI Vision", desc: "计算机视觉与图像理解技术" },
        { name: "NLP", desc: "自然语言理解与知识结构分析" },
        { name: "Decision AI", desc: "数据驱动决策与预测系统" },
        { name: "Robotics", desc: "机器人控制与智能系统" },
        { name: "Future Tech", desc: "探索前沿科技边界" }
    ];
    ...
    console.log('Three.js script ended without errors');
} catch (error) {
